            ...
            <div class="text-center card-box">
                <div class="pt-2 pb-2">
                    ...
                    <h4 class="mt-3"><a href="extras-profile.html" class="text-dark">
                        Ingeniería de Software II</a></h4>
        ...
        <div class="col-lg-4">
            <div class="text-center card-box">
                <div class="pt-2 pb-2">
                    ...
                    <h4 class="mt-3"><a href="extras-profile.html" class="text-dark">
                        Prácticas Profesionalizantes III</a></h4>
                    <p>Gisela Agusti</p>
                    <div class="font-14 mt-3">
        ...
        <div class="col-lg-4">
            <div class="text-center card-box">
                <div class="pt-2 pb-2">
                    ...
                    <h4 class="mt-3"><a href="extras-profile.html" class="text-dark">Algoritmos y Estructura de Datos III</a></h4>
        ...
        <div class="col-lg-4">
            <div class="text-center card-box">
                <div class="pt-2 pb-2">
                    ...
                    <h4 class="mt-3"><a href="extras-profile.html" class="text-dark">
                        Seminario de Actualización</a></h4>
        ...
        <div class="col-lg-4">
            <div class="text-center card-box">
                <div class="pt-2 pb-2">
                    ...
                    <h4 class="mt-3"><a href="extras-profile.html" class="text-dark">
                        Aspectos Legales de la Profesión</a></h4>
